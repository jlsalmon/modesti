...
//
//import cern.modesti.security.SAMLUserDetailsServiceImpl;
...
//        .getResource("classpath:/saml/newKeystore.jks");
//    String storePass = "password";
//    Map<String, String> passwords = new HashMap<String, String>();
//    passwords.put("modesti-test", "password");
//    String defaultKey = "modesti-test";
...
////  }
//
//  @Bean(name = "idp-cern-dev")
//  public ExtendedMetadataDelegate ssoCernExtendedMetadataProvider() throws MetadataProviderException, IOException {
//    @SuppressWarnings({ "deprecation"})
////    HTTPMetadataProvider metadataProvider
////        = new HTTPMetadataProvider("https://login-dev.cern.ch/FederationMetadata/2007-06/FederationMetadata.xml", 5000);
////    metadataProvider.setParserPool(parserPool());
//    FilesystemMetadataProvider metadataProvider = new FilesystemMetadataProvider(new ClassPathResource("saml/cern-idp-pro.xml").getFile());
//    metadataProvider.setParserPool(parserPool());
//
//    ExtendedMetadataDelegate extendedMetadataDelegate =
...
//    providers.add(ssoCernExtendedMetadataProvider());
...
//    metadataGenerator.setEntityId("cern:modesti:sp");
