...
public class TaskControllerTest extends BaseIntegrationTest {
  ...
  public void setup() throws Exception {
    ...
    taskList.add(new TaskInfoImpl("task1", null, null, null, null, new HashSet<>(Collections.singletonList("modesti-creators"))));
  }
  ...
  void setConverters(HttpMessageConverter<?>[] converters) {
    this.mappingJackson2HttpMessageConverter = Arrays.stream(converters).filter(hmc -> hmc instanceof MappingJackson2HttpMessageConverter).findAny()
        .get();
