...
//  };
//
//  public constructor(data: any[], columns: any[], settings: any = {}) {
//    this.settings = $.extend(this.settings, settings);
//    this.settings.data = data;
//    this.settings.columns = columns;
//
//    this.settings.columns.forEach((column: any) => column.renderer = settings.cellRenderer);
...
//      this.settings.columns = columns;
//      this.settings.columns.forEach((column: any) => column.renderer = this.settings.cellRenderer);
//      this.hot.updateSettings({
//        columns: columns
//      });
//    }
